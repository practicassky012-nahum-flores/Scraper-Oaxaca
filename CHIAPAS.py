...
# Iniciar el navegador
driver.get('http://compilacion.ordenjuridico.gob.mx/poderes2.php?edo=7')
...
download_directory = "C:\\Users\\pro02\\Documents\\azurite\\CHIAPAS DOF"
...
try:
    ...
    for fila in filas:
        ...
        if href_enlace and 'javascript:' in href_enlace:
            logging.warning(f"Saltando enlace con javascript:void - {enlace.text.strip()}")
            continue
