...
driver('http://www.ordenjuridico.gob.mx/estatal.php?liberado=si&edo=3#gsc.tab=0')
...
try:
    ...
    EC.element_to_be_clickable((By.XPATH, '//a[@href="./estatal.php?liberado=si&edo=3" and @class="notas_rapidas"]'))
    )
