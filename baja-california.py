...
# Iniciar el navegador
driver.get('http://compilacion.ordenjuridico.gob.mx/poderes2.php?edo=2')
...
download_directory = "C:\\Users\\pro02\\Documents\\azurite\\BAJA CALIFORNIA DOF"
            ...
            try:
                enlace_descarga = wait.until(
                    EC.presence_of_element_located(
                        (By.XPATH, f"//a[contains(@href, 'obtenerpdf.php') and contains(@href, '.{extension}')]") 
                    )
                )
